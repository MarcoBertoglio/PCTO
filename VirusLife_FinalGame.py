...
legend_font = pygame.font.Font('04B_19.TTF',30)
...
def vaccineGenerator():     
    ...
    top_vaccine = vaccine.get_rect(midbottom = (width, ran_vaccine_position - 150))
...
while done == True: 
    ...
    while main == True:   
       ...
       #uso fotocamera
        ...
        legend = legend_font.render(f'ALZA E ABBASSA LA MANO PER MUOVERE IL VIRUS...' ,True,(255,255,255))
        legend_rect = legend.get_rect(center = (600,600))
        screen.blit(legend,legend_rect)
